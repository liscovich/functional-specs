...
<!---Uncomment me when the Introduction is written
<section class="pages">
<ul>
	...
	<li>2 &nbsp; <a href="#Researcher_Site">Researcher Site</a></li>
		<ul>
			...
			<li>2.10 &nbsp; <a href="#RSProfile">Public Profile</a></li>
			<li>2.11 &nbsp; <a href="#RSEdit_Profile">Edit Profile</a></li>
			<li>2.12 &nbsp; <a href="#RSSearch_Results">Search Results</a></li>		
		</ul>
...
The overall interface of the Experiments page resembles an Amazon product list page:
...
# <a name="RSProfile"></a>1.10 Public Profile
